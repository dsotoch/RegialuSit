...
$(document).on('click', '.btn-delete', function () {
    ...
    swal({
        ...
        if (value == true) {
            $.ajax({
                type: "get",
                url: "/Periodos/EliminarPeriodo/" + id + "/",
